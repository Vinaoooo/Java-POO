...
public class Main {
    public static void main(String[] args) {
        ...
        // Chamdando outro objeto e definindo os valores 
        Cachorro cachorro1;
        cachorro1 = new Cachorro();
        cachorro1.setNome("Moacir")  ;
        cachorro1.setCor("Caramelo");
        cachorro1.setAltura(25);
        cachorro1.setPeso(2.5);
        cachorro1.setTamanhoDoRabo(5);

        // Chamando um metodo sem retorno
        cachorro1.latir();
        
        // Chamando um metodo com retorno - Como é um metodo com retorno precisa imprimir na tela
        System.out.println("O cachorro pegou uma " + cachorro1.pegar());

        // Imprimindo os objetos
        System.out.println(cachorro1.getNome() + " " + cachorro1.getCor() + " " + cachorro1.getAltura() + " " + cachorro1.getPeso() + " " + cachorro1.getTamanhoDoRabo());


        //Imprimindo interações com case
        System.out.println("O " + cachorro1.getNome() + " está "+ cachorro1.interagir("nada"));
        System.out.println("O " + cachorro1.getNome() + " está "+ cachorro1.interagir("Vai deitar"));
        System.out.println("O " + cachorro1.getNome() + " está "+ cachorro1.interagir("carinho"));

        System.out.println("-------------------------------------------");

        //Imprimindo interações com IF
        System.out.println("O " + cachorro1.getNome() + " está "+ cachorro1.interagir2("nada"));
        System.out.println("O " + cachorro1.getNome() + " está "+ cachorro1.interagir2("Vai deitar"));
        System.out.println("O " + cachorro1.getNome() + " está "+ cachorro1.interagir2("carinho"));
